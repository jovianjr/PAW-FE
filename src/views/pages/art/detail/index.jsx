...
const ArtDetail = () => {
	return <>
		<div className="container px-4 lg-px-6 lg:max-w7xl mx-auto grid lg:grid-cols-12 md:grid-cols-6 sm:grid-cols-4 my-4 mb:my-8 lg:my-16">
			<div className="col-span-2 md:col-span-2 sm:col-span-1"></div>
			<div className="md:col-span-8 sm:col-span-4">
				<img className="object cover mt-8 rounded-t-sm rounded-b-sm" src="/src/views/pages/art/detail/img/picture.jpg"
				sizes="(max-width: 1110px) 100vw, 1110px" height="592"/>
				<div className="flex items-center space-x-3 mt-2">
					<img class="w-14 h-14 rounded-full object-cover" src="/src/views/pages/art/detail/img/profile.jpg"/>
						<div className="flex flex-col lg:flex-row 2xl:flex-row">
							<p className="font-bold lg:ml-14">Watercolor Paintings from Aqua
							<br />
							<p className="font-normal">John Doe</p></p>
							<p className="lg:text-right lg:ml-80">January 2022</p>
						</div>
				</div>
